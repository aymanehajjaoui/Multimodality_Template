...
void write_data_csv(Channel_CH1 &channel, const std::string &filename)
{
    try
    {
        ...
        while (true)
        {
            ...
            {
                std::shared_ptr<data_part_CH1_t> part = channel.data_queue_csv.front();
