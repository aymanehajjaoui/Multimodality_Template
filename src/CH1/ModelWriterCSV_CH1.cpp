...
void log_results_csv(Channel_CH1 &channel, const std::string &filename)
{
    try
    {
        ...
        while (true)
        {
            ...
            {
                const model_result_CH1_t &result = channel.result_buffer_csv.front();
