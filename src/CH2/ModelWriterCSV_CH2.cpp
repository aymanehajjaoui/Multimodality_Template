...
void log_results_csv(Channel_CH2 &channel, const std::string &filename)
{
    try
    {
        ...
        while (true)
        {
            ...
            {
                const model_result_CH2_t &result = channel.result_buffer_csv.front();
