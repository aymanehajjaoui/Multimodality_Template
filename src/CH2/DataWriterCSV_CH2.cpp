...
void write_data_csv(Channel_CH2 &channel, const std::string &filename)
{
    try
    {
        ...
        while (true)
        {
            ...
            {
                std::shared_ptr<data_part_CH2_t> part = channel.data_queue_csv.front();
