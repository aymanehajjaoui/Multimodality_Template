...
template void write_data_csv<input_type1, output_type1>(Channel<input_type1, output_type1> &, const std::string &);
template void write_data_csv<input_type2, output_type2>(Channel<input_type2, output_type2> &, const std::string &);