...
template void write_data_tcp<input_type1, output_type1>(Channel<input_type1, output_type1> &, int);
template void write_data_tcp<input_type2, output_type2>(Channel<input_type2, output_type2> &, int);
